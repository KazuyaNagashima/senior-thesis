...
#ngs.plot.r -G ${ngs_ref} -R genebody -C list.txt -O comparison_genebody -L 4000 -FL 200
#ngs.plot.r -G ${ngs_ref} -R tss -C list.txt -O comparison_tss -L 4000 -FL 200
#ngs.plot.r -G ${ngs_ref} -R genebody -C list.txt -O k-means -L 4000 -FL 200 -GO km -KNC 10 -NRS 200
